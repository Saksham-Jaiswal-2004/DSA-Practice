...
int main()
{
    vector<int> data = {7,7,7,7,12,7,7};
    int numberOfBouquets = 2;
    int flowersInEachBouquet = 4;

    for(int i: data)
    cout<<i<<", ";
    cout<<endl;

    cout<<"Number of Bouquets: "<<numberOfBouquets<<endl;
    cout<<"Flowers in each Bouquet: "<<flowersInEachBouquet<<endl<<endl;

    cout<<"Minimum days reuired to make such bouquets: "<<minDays(data, numberOfBouquets, flowersInEachBouquet)<<endl;
